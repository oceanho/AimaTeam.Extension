...
namespace Aima.Extension.Kernal.Tree.Impl
{
    ...
    /// </summary>
    public class EmptyGuidIdTree<TDataElement> : AbstractTree<Guid, EmptyGuidIdTree<TDataElement>, TDataElement> where TDataElement : class, new()
    {
        /// <summary>
        /// 实例化一个ID类型为Guid的树形结构对象
        /// </summary>
        /// <param name="dataElementCollection">数据集合对象</param>
        public EmptyGuidIdTree(IEnumerable<TDataElement> dataElementCollection)
