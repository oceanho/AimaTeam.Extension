...
namespace Aima.Extension.Kernal.Tree.Impl
{
    ...
    /// </summary>
    public class EmptyInteger64IdTree<TDataElement> : AbstractTree<long, EmptyInteger64IdTree<TDataElement>, TDataElement> where TDataElement : class, new()
    {
        /// <summary>
        /// 实例化一个ID类型为long的树形结构对象
        /// </summary>
        /// <param name="dataElementCollection">数据集合对象</param>
        public EmptyInteger64IdTree(IEnumerable<TDataElement> dataElementCollection)
