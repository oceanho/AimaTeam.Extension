...
namespace Aima.Extension.Kernal.Tree.Impl
{
    ...
    /// </summary>
    public class EmptyStringIdTreeT<TDataElement> : AbstractTree<string, EmptyStringIdTreeT<TDataElement>, TDataElement> where TDataElement : class, new()
    {
        /// <summary>
        /// 实例化一个ID类型为string的树形结构对象
        /// </summary>
        /// <param name="dataElementCollection">数据集合对象</param>
        public EmptyStringIdTreeT(IEnumerable<TDataElement> dataElementCollection)
